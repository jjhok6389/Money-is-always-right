...
| 바로가기        | 링크                                                           |
| ----------- | ------------------------------------------------------------ |
| 프론트 (로컬)    | [http://127.0.0.1:5173](http://127.0.0.1:5173)               |
| 백엔드 Health  | [http://127.0.0.1:8000/health](http://127.0.0.1:8000/health) |
| Swagger     | [http://localhost:8000/docs](http://localhost:8000/docs)     |
| 데모 배포 가이드   | [docs/DEPLOY.md](./docs/DEPLOY.md)                           |
...
| Jira      | 할 일         | 디벨롭 포인트                                                                    |
| --------- | ----------- | -------------------------------------------------------------------------- |
| YP2026-61 | 클라우드 MVP 배포 | [docs/DEPLOY.md](./docs/DEPLOY.md) — Vercel + Render |
